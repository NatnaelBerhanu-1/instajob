...
class ResumeDetailsCubit extends Cubit<ResumeDetailsState> {
  ...
  Future<void> execute({
    ...
    emit(ResumeDetailsSuccess(
        resumeDetail: mockResumeDetail)); //TODO: replace mock with real data
    // ApiResponse response =
    //     await repo.getParsedResumeDetails(resumeUrl: resumeUrl);

    // if (response.appStatusCode == AppStatusCode.serverError) {
    //   emit(ResumeDetailsErrorState(
  ...
  ResumeDetailModel mockResumeDetail = ResumeDetailModel(
      ...
      experience: [
        ...
        Experience(
            location: "Atlanta",
            organization: "Atlanta Technical College",
            title: "Associate"),
        Experience(
            location: "Atlanta",
            organization: "Atlanta Technical College",
