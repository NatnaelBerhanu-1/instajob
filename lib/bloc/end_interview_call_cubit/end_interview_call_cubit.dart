...
class EndInterviewCallScheduleCubit extends Cubit<EndInterviewCallScheduleState> {
  ...
  Future<void> endInterviewCallSchedule({required String callId, required EndCallRecordingPayload? endCallRecordingPayload}) async {
    emit(EndInterviewCallScheduleLoading(callId: callId));
    ApiResponse response = await repo.endInterviewCallSchedule(callId: callId, endCallRecordingPayload: endCallRecordingPayload);
